...
impl CopilotAdapter {
    ...
    fn apply_rules(&self, files: &[PresetFile], strategy: &MergeStrategy, result: &mut ApplyResult, mode: &mut ConflictMode) -> Result<()> {
        ...
        preset_content.push_str("<!-- Generated by aidot - DO NOT EDIT MANUALLY -->\n\n");
        ...
        match strategy {
            ...
            MergeStrategy::Replace => {
                ...
                *mode = write_with_conflict(&instructions_file, &preset_content, *mode, result, ".github/copilot-instructions.md")?;
            }
        }
